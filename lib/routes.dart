...
Map<String, WidgetBuilder> mesRoutes() => {
      ...
      '/home': (BuildContext context) => const HomePage(title: "Menu principal"),
      '/menu/profile': (BuildContext context) => const Profile(title: "Votre profil"),
      '/menu/profile/editer': (BuildContext context) => const ProfileEditer(title: "Modifiez votre profil"),
      '/menu/rh': (BuildContext context) => const RH(title: "Menu Ressources Humaines"),
      '/menu/compta': (BuildContext context) => const Compta(title: "Menu Comptabilité"),
    };
